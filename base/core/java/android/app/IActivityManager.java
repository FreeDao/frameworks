...
public interface IActivityManager extends IInterface {
	...
	int GET_TOP_ACTIVITY_COMPONENTNAME_TRANSACTION = IBinder.FIRST_CALL_TRANSACTION + 200;
    //#endif /* VENDOR_EDIT */
    //#ifdef VENDOR_EDIT
    //licx@OnLineRD.framework, add
	//for key_intercept:
	int FIX_KEYEVENT_INTERCEPTOR_IN_PROCESS_TRANSACTION = IBinder.FIRST_CALL_TRANSACTION + 202;
	int CHECK_KEYEVENT_INTERCEPTOR_TRANSACTION = IBinder.FIRST_CALL_TRANSACTION + 203;
	int IS_IN_INTERCEPTOR_MAP_TRANSACTION = IBinder.FIRST_CALL_TRANSACTION + 204;
	//for privacy_protect:
	int SET_SECURE_CONTROLLER_TRANSACTION = IBinder.FIRST_CALL_TRANSACTION + 205;
    //#endif /* VENDOR_EDIT */
    //#ifdef VENDOR_EDIT
    //licx@OnLineRD.framework.key_intercept, add
    public int INVALIDATE_ARRAY_LENGTH = -1;
    //#endif /* VENDOR_EDIT */
}
