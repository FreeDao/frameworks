...
public final class Sensor {
    ...
    //#ifdef VENDOR_EDIT  
	//#Jevons@OnlineRd.DeviceService.version, 2013/10/22 , add for Oppo Sesor
	public static final int TYPE_IR_GESTUR = 30;   // Infrared Sensor
    public static final int TYPE_MOTION_RELATIVE = 33171007;
    public static final int TYPE_PEDOMETER  = 33171009;
    private static final int[] OppoSensorType = {
                    TYPE_IR_GESTUR,
                    TYPE_MOTION_RELATIVE,
                    TYPE_PEDOMETER
    };
    private static final int[] sOppoSensorReportingModes = {
                    REPORTING_MODE_CONTINUOUS,
                    REPORTING_MODE_CONTINUOUS,
                    REPORTING_MODE_CONTINUOUS
    };
    private static int[] sOppoSensorMaxLengthValuesArray = {
            3, 3, 3
    };
	//#endif
