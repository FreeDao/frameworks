...
/**
 * This class represents the CLF filter rule data object (CLF_FILTER_DO), according
 * to verizone requirement.
 *
    ...
    public void translate() throws DoParserException {
        ...
        do {
            ...
            if( temp.getTag() == FilterEntryDo._TAG ) { // NFC-AR-DO
                mFilterEntryAr = new FilterEntryDo( data, temp.getValueIndex(), temp.getValueLength());
