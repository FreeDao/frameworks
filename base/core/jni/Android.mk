...
#licx@OnLineRD.framework.oppo_debug, add
LOCAL_SRC_FILES += com_oppo_debug_Assert.cpp
endif

ifeq ($(VENDOR_EDIT), yes)
#wenhua.Leng@MultiMedia.Graphics.oppo_protecteyes.
#LOCAL_SRC_FILES += com_oppo_protecteyes_ProtectEyes.cpp
endif
