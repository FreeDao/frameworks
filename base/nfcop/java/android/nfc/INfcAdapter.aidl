...
interface INfcAdapter
{
    ...
    int[] getSecureElementList(in String pkg);
    int getSelectedSecureElement(in String pkg);
    int selectSecureElement(in String pkg, int seId);
    int deselectSecureElement(in String pkg);
    void storeSePreference(in String pkg, int seId);
