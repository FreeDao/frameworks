...
#oppo yuyi 2013-11-05 add begin for add 14001 and 14021
#ifdef VENDOR_EDIT
ifeq ($(filter-out MSM_14021 MSM_14091 MSM_14001,$(OPPO_TARGET_DEVICE)),)
...
FRAMEWORKS_BASE_JAVA_SRC_DIRS += \
	$(addprefix frameworks/base/, nfcop/java)
endif      
#endif
#oppo yuyi 2013-11-05 add end for add 14001 and 14021
...
NFC_NEW_SRC := \
	nfcop/java/android/nfc \
	nfcop/java/com/vzw \
	
ifeq ($(filter-out MSM_14021 MSM_14091 MSM_14001,$(OPPO_TARGET_DEVICE)),)
LOCAL_SRC_FILES := $(filter-out \
			$(call find-other-java-files, $(NFC_SRC)) \
			,$(LOCAL_SRC_FILES))
else
LOCAL_SRC_FILES := $(filter-out \
			$(call find-other-java-files, $(NFC_NEW_SRC)) \
			,$(LOCAL_SRC_FILES))
endif
#endif
#oppo yuyi 2013-11-05 add end for add 14001 and 14021
...
ifeq ($(VENDOR_EDIT), yes)
#licx@OnLineRD.framework.oppo_service, add
LOCAL_SRC_FILES += core/java/android/os/IOppoService.aidl 
endif


#oppo yuyi 2013-11-05 modify begin for add 14001 and 14021
#ifdef VENDOR_EDIT
ifeq ($(filter-out MSM_14021 MSM_14091 MSM_14001,$(OPPO_TARGET_DEVICE)),)
LOCAL_SRC_FILES += \
	nfcop/java/android/nfc/IAppCallback.aidl \
	nfcop/java/android/nfc/INfcAdapterExtras.aidl \
	nfcop/java/android/nfc/INfcAccessExtras.aidl \
	nfcop/java/android/nfc/INfcTag.aidl \
	nfcop/java/android/nfc/INfcAla.aidl \
	nfcop/java/android/nfc/INfcCardEmulation.aidl \
	nfcop/java/android/nfc/INfcAdapter.aidl 
else	
LOCAL_SRC_FILES += \
	core/java/android/nfc/IAppCallback.aidl \
	core/java/android/nfc/INfcAdapter.aidl \
	core/java/android/nfc/INfcAdapterExtras.aidl \
	core/java/android/nfc/INfcAccessExtras.aidl \
...
ifeq ($(filter-out MSM_14021 MSM_14091 MSM_14001,$(OPPO_TARGET_DEVICE)),)
aidl_files += \
	frameworks/base/nfcop/java/android/nfc/NdefMessage.aidl \
	frameworks/base/nfcop/java/android/nfc/NdefRecord.aidl \
	frameworks/base/nfcop/java/android/nfc/Tag.aidl 
else	
aidl_files += \
	frameworks/base/core/java/android/nfc/NdefMessage.aidl \
	frameworks/base/core/java/android/nfc/NdefRecord.aidl \
...
#endif
#oppo yuyi 2013-11-05 modify end for add 14001 and 14021
